 ...
 * 
 * <p>This exception is used throughout the application to indicate that a requested
 * entity (such as an employee, warehouse, item, etc.) does not exist in the system.
 * 
